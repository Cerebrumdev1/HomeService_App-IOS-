...
open class HorizontalCalendarView: UIView {
  let cellReuseIdentifier = "AppCalenderCollectionCell"
  ...
  public override init(frame: CGRect) {
    ...
    collectionView!.register(UINib(nibName: "AppCalenderCollectionCell", bundle: Bundle(for: HorizontalCalendarView.self)), forCellWithReuseIdentifier: cellReuseIdentifier)
    setupCollectionView()
    setupYears()
  }
